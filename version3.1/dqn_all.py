...
from env.env_discrete import ENV_DISCRETE
...
class SaveOnBestTrainingRewardCallback(BaseCallback):
    ...
    def __init__(self, check_freq: int, log_dir: str, verbose=1):
        ...
        print(self.log_dir, self.save_path)
    ...
    def _on_step(self) -> bool:
        if self.n_calls % self.check_freq == 0:
          ...
          x, y = ts2xy(load_results(self.log_dir), 'timesteps') # log_dir: model_save/
          if len(x) > 0:
              ...
              if mean_reward > self.best_mean_reward:
                  ...
                  self.model.save(self.save_path)   # save_path: model_save/best_model
...
'''
episode数=iteration数=reset多少次，在这里是timestep/seq_time
step数=每个episode里面走多远距离=step多少次，在这里是seq_time
'''