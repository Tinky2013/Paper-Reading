...
# 全局参数：根据不同的测试任务进行修改
MODEL_PATH = 'td3_sp2'  # 要测试哪个模型
TEST_STOCK_NUM = 10     # 要测试多少支股票
ST = '2019' # 从哪年的第一个交易日开始测试
ED = '2020' # 到哪年的第一个交易日结束测试
# 设定要画什么图
VIS_DT = {
    'ave_bh_and_port': True,    # 所有股票测试时期buy_hold和portfolio对比曲线图
    'ave_zr_and_port': True,    # 所有股票测试时期portfolio和zz500指数对比图
    'port_and_bh_dist': True,   # 股票buy_hold和portfolio分布对比图
    'port_minus_bh_dist': True, # 股票portfolio与buy_hold差值对比图
}
